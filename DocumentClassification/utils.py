...
def load_corpus(dataset_str):
    ...
    for p in phases:
        index_dict[p] = load_pkl("DocumentClassification/data/ind.{}.{}.x".format(dataset_str, p))
        label_dict[p] = load_pkl("DocumentClassification/data/ind.{}.{}.y".format(dataset_str, p))

    adj = load_pkl("DocumentClassification/data/ind.{}.BCD.adj".format(dataset_str))
